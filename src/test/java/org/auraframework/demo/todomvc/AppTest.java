package org.auraframework.demo.todomvc;
...
public class AppTest extends TestCase {
    ...
    public void testApp() throws Exception {
        ...
        HttpGet get = new HttpGet("http://localhost:8080/todoMVC/todoMVC.app");
        ...
        if (entity == null) {
            ...
            assertTrue("Hello response is wrong", EntityUtils.toString(entity).contains("hello web, from the Aura sample app todoMVC"));
        }
    }
}
